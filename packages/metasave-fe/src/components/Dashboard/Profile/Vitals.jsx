    ...
    <div className='my-10 grid grid-cols-1 md:grid-cols-4 gap-5'>
        <div className='col-span-1 md:col-span-3'>
            <div className='grid grid-cols-1 md:grid-cols-3 gap-5'>
                <div className='bg-[#B3DEE2] rounded-[15px] px-5 py-5 flex flex-col'>
                ...
                <div className='bg-[#2A9D8F] rounded-[15px] px-5 py-5 flex flex-col'>
                ...
                <div className='md:col-span-2 bg-[#B3DEE2] rounded-[15px] px-5 py-5 flex justify-between'>
        ...
        <div className='bg-[#2A9D8F] rounded-[15px] px-5 py-10 flex flex-col justify-between'>
